import{i as f}from"./nav-HNmldmSY.js";import{r as g,i as y}from"./citations-JdN-Zrlu.js";function _(d=".timeline-entry",u=6){const c=Array.from(document.querySelectorAll(d)),n=document.querySelector(".pagination");if(!c.length||!n)return;const i=Math.ceil(c.length/u);function m(){const t=window.location.hash.match(/page=(\d+)/),r=t?parseInt(t[1],10):1;return Math.max(1,Math.min(r,i))}function p(e){const t=(e-1)*u,r=t+u;c.forEach((s,a)=>{s.hidden=a<t||a>=r}),b(e);const o=document.querySelector(".timeline");o&&e>1&&o.scrollIntoView({behavior:"smooth",block:"start"})}function b(e){const t=e===1,r=e===i;n.innerHTML=`
      ...
      <div class="pagination__pages" role="group" aria-label="Page navigation">
        ${Array.from({length:i},(a,E)=>{const l=E+1;return`<button class="pagination__page${l===e?" active":""}"
                          aria-label="Page ${l}"
                          aria-current="${l===e?"page":"false"}"
                          data-page="${l}">${l}</button>`}).join("")}
      </div>
